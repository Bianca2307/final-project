    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="col-md-6 col-sm-12 col-xs-12">
          ...
          <p className="fs-4">
            <strong>Stock: </strong>{currentProduct.stock}</p>
          <p className="fs-4">
            <strong>Size: </strong>{currentProduct.size}</p>
          <p className="fs-4">
            <strong>Categories: </strong>{currentProduct.categories.join(", ")}</p>
          <p className="fs-3 fw-bold">{currentProduct.price} Lei</p>
